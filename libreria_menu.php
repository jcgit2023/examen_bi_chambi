...
if (isset($_SESSION["sesion_id_rol"])){
    $sql1 = $db->Prepare("SELECT nombre, logo
        ...
        if ($cuerp==false){
            echo"<img src='../tienda_lucy/logos/{$logo}' width='10%' >";
        }
        else {
            echo"<img src='privada/tienda_lucy/logos/{$logo}' width='10%' >";
        }
    ...
    echo"<html>
            <head>";
            if($cuerp == false)
    echo"<link rel='stylesheet' href='../../css/menu_despegable.css' type='text/css'>";
        else
    echo"<link rel='stylesheet' href='css/menu_despegable.css' type='text/css'>";
                ...
                foreach ($rs as $r => $fila) {
                    ...
                    if ($cuerp == false or $cuerp == ""){
                        echo"<li><a onclick='location.href=\"../".$fila2["contenido"]."\"' ' style='cursor:pointer;'>".$fila2["opcion"]."</a></li>";
                                ...
                                echo"<li><a onclick='location.href=\"sis_minisuper_CHAMBI/".$fila2["contenido"]."\"'  style='cursor:pointer;'>".$fila2["opcion"]."</a></li>";
                }
        }
        echo"</ul>";
    echo"</li>";
